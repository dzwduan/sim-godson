/* this file contains almost all the structures which are defined on the riscv
...
/* for now we handle only 32bit riscv, if simplescalar itself
 ...
 */
 ...
 #ifndef _RISCV_DATA_STRUCT_
 #define _RISCV_DATA_STRUCT_
...
typedef t_ulong_t riscv_old_sigset_t;
...
struct ss_sysinfo {
  ...
  char ss_f[20 - 2 * sizeof(t_long_t) -
...
struct ss_timex {
  ...
  t_long_t ss_tolerance;     /* clock frequency tolerance (ppm) (read only) */
